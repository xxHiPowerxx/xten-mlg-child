 ...
 */
function xten_child_custom_post_types() {
	/**
	...
	$post_names       = create_post_labels(
		$post_singular,
		null,
		'Cases can be Categorized by Practice-Area'
	);
	$post_plural      = $post_names['post_plural'];
	$post_description = $post_names['post_description'];
	$post_handle      = $post_names['post_handle'];
	...
	$args = array(
		...
		// 'rewrite'             => false,
		'rewrite'             => array(
			// 'slug'       => $post_handle . '/%practice-area%',
			'slug'       => $post_handle,
			'with_front' => false,
		),
	);
	...
	/**
	 * Create Practice Areas Custom Post Type
	 */
	$post_singular    = 'Practice Area';
	$post_names       = create_post_labels(
		$post_singular,
		null,
		'Practice Areas can be types of Cases'
	);
	$post_plural      = $post_names['post_plural'];
	$post_description = $post_names['post_description'];
	$post_handle      = $post_names['post_handle'];
...
add_action( 'init', 'xten_child_custom_post_types', 0 );